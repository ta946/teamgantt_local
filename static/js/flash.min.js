...
var $message_container = $("<div id='flash'></div>");
...
function flash(message, options = null){
  ...
  switch($options.type) {
    case 'info':
      $options.ftColor = "#6ea8fe";
      $options.bgColor = "#031633";
      break;
    case 'success':
      $options.ftColor = "#75b798";
      $options.bgColor = "#0f5132";
      break;
    case 'warning':
      $options.ftColor = "#ffda6a";
      $options.bgColor = "#332701";
      break;
    case 'danger':
      $options.ftColor = "#ea868f";
      $options.bgColor = "#2c0b0e";
      break;
    // default:
    //   $options.bgColor = 
  }
